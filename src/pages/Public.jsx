    ...
    return (
        <div className="public">
            <div className="public__main">
                <div className="public__card1">
                    <div className="public__card1--contenido">
                        <div className="public__card1--tittle">
                            <h1>Proyectos S.A.S</h1>
                        </div>
                        <div className="public__card1--text">
                            <p>
                ...
                <div className="public__card2">
                    <div className="public__car2--div">
